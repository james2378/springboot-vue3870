<template>
	<div class="diy_details_box diy_div_have_an_appointment_with_a_doctor">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "have_an_appointment_with_a_doctor_id",
					source_id: this.obj["have_an_appointment_with_a_doctor_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/have_an_appointment_with_a_doctor/set?have_an_appointment_with_a_doctor_id=' + _this.obj["have_an_appointment_with_a_doctor_id"], {
								praise_len
							}, (res) => {
								if(res.result){
