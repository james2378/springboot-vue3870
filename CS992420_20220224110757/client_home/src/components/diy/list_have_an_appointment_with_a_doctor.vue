<template>
	<div class="diy_home diy_list diy_have_an_appointment_with_a_doctor" id="diy_have_an_appointment_with_a_doctor_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/have_an_appointment_with_a_doctor/details?have_an_appointment_with_a_doctor_id=' + o['have_an_appointment_with_a_doctor_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/have_an_appointment_with_a_doctor/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/have_an_appointment_with_a_doctor/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','pet_sex')">宠物性别
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','registration_fee')">
						<span>
							{{ o["registration_fee"] }}
						</span>
					</td>
