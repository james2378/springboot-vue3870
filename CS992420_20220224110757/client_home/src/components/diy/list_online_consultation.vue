<template>
	<div class="diy_home diy_list diy_online_consultation" id="diy_online_consultation_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/online_consultation/details?online_consultation_id=' + o['online_consultation_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/online_consultation/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/online_consultation/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','consulting_questions')">咨询问题
					</th>
					<th class="diy_title" v-if="$check_field('get','doctor_reply')">医生回复
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','consulting_questions')">
						<span>
							{{ o["consulting_questions"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','doctor_reply')">
						<span>
							{{ o["doctor_reply"] }}
						</span>
					</td>
