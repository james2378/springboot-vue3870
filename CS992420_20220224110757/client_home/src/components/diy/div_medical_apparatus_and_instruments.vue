<template>
	<div class="diy_details_box diy_div_medical_apparatus_and_instruments">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "medical_apparatus_and_instruments_id",
					source_id: this.obj["medical_apparatus_and_instruments_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/medical_apparatus_and_instruments/set?medical_apparatus_and_instruments_id=' + _this.obj["medical_apparatus_and_instruments_id"], {
								praise_len
							}, (res) => {
								if(res.result){
