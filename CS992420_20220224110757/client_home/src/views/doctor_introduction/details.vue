<template>
	<div class="diy_details page_doctor_introduction" id="doctor_introduction_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_doctor_introduction'>
							<div_doctor_introduction :obj="obj"></div_doctor_introduction>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_doctor_introduction from "@/components/diy/div_doctor_introduction.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/doctor_introduction/set?doctor_introduction_id=' + obj["doctor_introduction_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.doctor_introduction_id;
				}
			},
			/**
			 * 初始化收藏状态
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "doctor_introduction",
					source_field: "doctor_introduction_id",
					source_id: obj["doctor_introduction_id"],
					user_id
				};
