		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','doctor_job_number') || $check_field('add','doctor_job_number') || $check_field('set','doctor_job_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生工号" prop="doctor_job_number">
					<el-input id="doctor_job_number" v-model="form_sub['doctor_job_number']" placeholder="请输入医生工号"
							  v-if="user_group === '管理员' || (form_sub['doctor_id'] && $check_field('set','doctor_job_number')) || (!form_sub['doctor_id'] && $check_field('add','doctor_job_number'))"></el-input>
					<div v-else-if="$check_field('get','doctor_job_number')">{{form_sub['doctor_job_number']}}</div>
				</el-form-item>
			</el-col>
