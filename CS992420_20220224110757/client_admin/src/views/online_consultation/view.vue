		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			<el-col v-if="user_group === '管理员' || $check_field('get','doctor_job_number') || $check_field('add','doctor_job_number') || $check_field('set','doctor_job_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生工号" prop="doctor_job_number">
						<el-select v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','doctor_job_number')) || (!form['online_consultation_id'] && $check_field('add','doctor_job_number'))" id="doctor_job_number" v-model="form['doctor_job_number']" :disabled="disabledObj['doctor_job_number_isDisabled']">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','name_of_doctor') || $check_field('add','name_of_doctor') || $check_field('set','name_of_doctor')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生姓名" prop="name_of_doctor">
					<el-input id="name_of_doctor" v-model="form['name_of_doctor']" placeholder="请输入医生姓名"
							  v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','name_of_doctor')) || (!form['online_consultation_id'] && $check_field('add','name_of_doctor'))" :disabled="disabledObj['name_of_doctor_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','department') || $check_field('add','department') || $check_field('set','department')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="科室" prop="department">
					<el-input id="department" v-model="form['department']" placeholder="请输入科室"
							  v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','department')) || (!form['online_consultation_id'] && $check_field('add','department'))" :disabled="disabledObj['department_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="用户名" prop="user_name">
						<div v-if="user_group !== '管理员'">
							...
							<!--v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','user_name')) || (!form['online_consultation_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','user_name')">{{form['user_name']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','user_name')) || (!form['online_consultation_id'] && $check_field('add','user_name'))" id="user_name" v-model="form['user_name']" :disabled="disabledObj['user_name_isDisabled']">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','pet_variety') || $check_field('add','pet_variety') || $check_field('set','pet_variety')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="宠物品种" prop="pet_variety">
					<el-input id="pet_variety" v-model="form['pet_variety']" placeholder="请输入宠物品种"
							  v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','pet_variety')) || (!form['online_consultation_id'] && $check_field('add','pet_variety'))" :disabled="disabledObj['pet_variety_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','pet_variety')">{{form['pet_variety']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','consulting_questions') || $check_field('add','consulting_questions') || $check_field('set','consulting_questions')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="咨询问题" prop="consulting_questions">
					<el-input type="textarea" id="consulting_questions" v-model="form['consulting_questions']" placeholder="请输入咨询问题"
						v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','consulting_questions')) || (!form['online_consultation_id'] && $check_field('add','consulting_questions'))" :disabled="disabledObj['consulting_questions_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','consulting_questions')">{{form['consulting_questions']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','doctor_reply') || $check_field('add','doctor_reply') || $check_field('set','doctor_reply')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="医生回复" prop="doctor_reply">
					<el-input type="textarea" id="doctor_reply" v-model="form['doctor_reply']" placeholder="请输入医生回复"
						v-if="user_group === '管理员' || (form['online_consultation_id'] && $check_field('set','doctor_reply')) || (!form['online_consultation_id'] && $check_field('add','doctor_reply'))" :disabled="disabledObj['doctor_reply_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','doctor_reply')">{{form['doctor_reply']}}</div>
				</el-form-item>
			</el-col>
